...
LLibrary\Models\Entities\User::refreshSession();
$db = LLibrary\Models\Managers\DBFactory::getMysqlConnexionWithPDO();
$config = new LLibrary\General\Configuration();
$visitor = new LLibrary\Models\Entities\Visitor(array(
