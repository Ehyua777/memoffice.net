...
class BlogSubjectManager extends DBFactory
{
	...
	public function add(\LLibrary\Models\Entities\BlogSubject $subject)
	{
		try {
			$sql = '
	...
	public function getList($debut = -1, $limite = -1)
	{
		...
		$query->setFetchMode(
			...
			'\LLibrary\Models\Entities\BlogSubject'
		);
	...
	public function update(\LLibrary\Models\Entities\BlogSubject $subject)
	{
	...
	public function save(\LLibrary\Models\Entities\BlogSubject $subject)
	{
		if ($subject->isValid()) {
