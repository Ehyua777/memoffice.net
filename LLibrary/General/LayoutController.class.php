...
class LayoutController extends \LLibrary\Models\Managers\DBFactory
{
	protected $title,
		$websiteName,
		$websiteDescription,
	...
	{
		$appTitle = new \LLibrary\Models\Managers\LayoutManager($this->db);
	...
	{
		$menuManager = new \LLibrary\Models\Managers\MenuManager($this->db);
	...
	{
		$ipManager = new \LLibrary\Models\Managers\GeoLocalisation($this->db);
	...
	public function __construct(\LLibrary\Models\Entities\Visitor $visitor)
	{
	...
	public function lSignature()
	{
		return $this->lSignature;
	}
	...
	public function visitorsNumber()
	{
		return $this->visitorsNumber;
	}
	public function membersNumber()
	{
		return $this->membersNumber;
	}
	public function noMembersNumber()
	{
		return $this->noMembersNumber;
	}
	...
	public function executeVisitorRegister(\LLibrary\Models\Entities\Visitor $visitor)
	{
		$ok = new \LLibrary\Models\Managers\GeoLocalisation($this->db);
